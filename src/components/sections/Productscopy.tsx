...
export const ProductsSection = () => {
  return (
    <section id="products" className="py-16 sm:py-24 relative overflow-hidden bg-gradient-to-br from-violet-100 via-purple-50 to-fuchsia-100 dark:from-violet-950 dark:via-purple-950 dark:to-fuchsia-950">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {products.map((product, index) => (
            ...
            >
              ...
              `}>
                {/* Product Icon */}
                <div className="absolute top-4 right-4 w-16 h-16 sm:w-20 sm:h-20 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center">
